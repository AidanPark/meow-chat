...
REFERENCE_TESTS = [
    ...
    {"code": "ANIONGAP", "name": "Anion Gap", "unit": "mmol/L", "meaning": "음이온 갭", "description": "대사성 산증 감별용 계산값 (Na + K - Cl - HCO₃)."},
    ...
    {"code": "Cl(Ven)", "name": "Chloride (Venous)", "unit": "mmol/L", "meaning": "정맥혈 염화이온", "description": "정맥혈 전해질 분석. 대사성 산·염기 균형 해석에 사용."},
    ...
    {"code": "CH", "name": "Cell Hemoglobin", "unit": "pg", "meaning": "적혈구 내 헤모글로빈 함량", "description": "단일 적혈구의 Hb 함량. 저색소성 빈혈 시 감소."},
    {"code": "CHCM", "name": "Cell Hemoglobin Concentration Mean", "unit": "g/dL", "meaning": "세포평균 헤모글로빈 농도", "description": "MCHC와 유사하지만, 세포 단위로 직접 산출. 빈혈 형태 분석에 사용."},
    ...
    {"code": "GRAN", "name": "Neutrophils (Absolute)", "unit": "K/µL", "meaning": "호중구 절대수 (단위 부피당 세포 수)", "description": "급성 염증, 세균 감염에서 크게 상승. 패혈증 등에서 급감 가능."},
    ...
    {"code": "LUC", "name": "Large Unstained Cells", "unit": "%", "meaning": "염색되지 않은 대형세포 비율", "description": "대식세포 또는 비정형 림프구 포함. 감염, 종양성 질환 등에서 증가 가능."},
    ...
    {"code": "MON", "name": "Monocytes (Absolute)", "unit": "K/µL", "meaning": "단핵구 절대수", "description": "만성 감염, 조직 손상 회복기에서 증가. 골수 기능 저하 시 감소."},
    ...
    {"code": "ALP/GPT", "name": "ALP/ALT Ratio", "unit": None, "meaning": "알칼리인산분해효소/알라닌아미노전이효소 비율", "description": "ALP/ALT 비율. 간세포성 vs 담즙정체성 간질환 감별에 참고."},
    ...
    {"code": "CHLORIDE", "name": "Chloride (Cl⁻)", "unit": "mEq/L", "meaning": "염화 이온 농도", "description": "산·염기 균형 유지. 구토나 대사성 알칼리증 시 감소."},
    ...
    {"code": "POTASSIUM", "name": "Potassium (K⁺)", "unit": "mEq/L", "meaning": "칼륨 이온 농도", "description": "신경전달, 근육 수축에 중요. 고칼륨혈증은 부정맥 유발, 저칼륨혈증은 근육 약화 유발."},
    {"code": "SDMA", "name": "Symmetric Dimethylarginine", "unit": "µg/dL", "meaning": "대칭성 디메틸아르기닌", "description": "조기 신장기능 저하를 감지하는 바이오마커. CREA보다 민감."},
    {"code": "SODIUM", "name": "Sodium (Na⁺)", "unit": "mEq/L", "meaning": "나트륨 이온 농도", "description": "체액 삼투압 및 수분 균형 조절. 탈수 시 증가, 신부전·부신부전 시 감소."},
    ...
    {"code": "TRIG", "name": "Triglyceride", "unit": "mg/dL", "meaning": "중성지방", "description": "혈중 에너지 저장 지질. 고지혈증, 내분비 이상 시 상승."},
    ...
    {"code": "Ketone", "name": "Urine Ketones", "unit": "mg/dL", "meaning": "소변 내 케톤체", "description": "당뇨병성 케톤산증, 기아 상태, 고지방식이 등에서 검출."},
    ...
    {"code": "T4", "name": "Total Thyroxine", "unit": "µg/dL", "meaning": "총 갑상선호르몬 (T4)", "description": "갑상선 기능 저하증 또는 항진증 진단에 사용되는 주요 지표."},
]
