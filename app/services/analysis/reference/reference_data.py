...
REFERENCE_TESTS = [
    ...
    {"code": "EOS", "name": "Eosinophils (Absolute)", "unit": "K/µL", "meaning": "호산구 절대수", "description": "기생충, 알레르기, 천식 시 증가."},
    ...
    {"code": "NEUTROPHILS", "name": "Neutrophils (Absolute)", "unit": "K/µL", "meaning": "호중구 절대수", "description": "세균 감염, 급성 염증 시 증가. 면역저하나 바이러스 감염 시 감소."},
    ...
    {"code": "LYMPHO", "name": "Lymphocytes (Absolute)", "unit": "K/µL", "meaning": "림프구 절대수", "description": "단위 부피당 림프구 수. 스트레스, 면역 반응 상태 평가에 활용."},
    ...
    {"code": "Ca", "name": "Calcium", "unit": "mg/dL", "meaning": "칼슘 농도", "description": "뼈 대사, 근육 수축, 신경전달에 관여. 저칼슘혈증은 저알부민혈증, 고칼슘혈증은 부갑상선·종양 관련."},
    {"code": "SODIUM", "name": "Sodium (Na⁺)", "unit": "mmol/L", "meaning": "나트륨 이온 농도", "description": "체액 삼투압 및 수분 균형 조절. 탈수 시 증가, 신부전·부신부전 시 감소."},
    {"code": "POTASSIUM", "name": "Potassium (K⁺)", "unit": "mmol/L", "meaning": "칼륨 이온 농도", "description": "신경전달, 근육 수축에 중요. 고칼륨혈증은 부정맥 유발, 저칼륨혈증은 근육 약화 유발."},
    {"code": "CHLORIDE", "name": "Chloride (Cl⁻)", "unit": "mmol/L", "meaning": "염화 이온 농도", "description": "산·염기 균형 유지. 구토나 대사성 알칼리증 시 감소."},
    {"code": "Creatinine", "name": "Creatinine", "unit": "mg/dL", "meaning": "크레아티닌 농도", "description": "신장 기능 평가 지표. 사구체 여과율 감소 시 상승."},
    {"code": "Glucose", "name": "Glucose", "unit": "mg/dL", "meaning": "혈당 농도", "description": "에너지 대사 지표. 당뇨병 시 상승, 패혈증·간질환 시 저하 가능."},
    {"code": "GPT/ALT", "name": "Alanine Aminotransferase (ALT)", "unit": "U/L", "meaning": "알라닌 아미노전이효소", "description": "간세포 손상 시 혈중 상승. 간질환, 약물 독성 평가 지표."},
    {"code": "GOT/AST", "name": "Aspartate Aminotransferase (AST)", "unit": "U/L", "meaning": "아스파르트산 아미노전이효소", "description": "간, 근육세포 손상 시 상승. 근육병증 감별에 CK와 함께 사용."},
    {"code": "T.Bilirubin", "name": "Total Bilirubin", "unit": "mg/dL", "meaning": "총 빌리루빈 농도", "description": "적혈구 용혈, 간세포 손상, 담즙 정체 시 상승. 황달 감별 지표."},
    {"code": "T.cholesterol", "name": "Total Cholesterol", "unit": "mg/dL", "meaning": "총 콜레스테롤 농도", "description": "지질대사 지표. 갑상선 기능저하증, 신증후군 등에서 상승."},
    {"code": "Lipase", "name": "Lipase", "unit": "U/L", "meaning": "리파아제", "description": "췌장 효소. 췌장염 진단 시 상승. AMYL과 함께 해석."},
    {"code": "Amylase", "name": "Amylase", "unit": "U/L", "meaning": "아밀라아제", "description": "췌장 및 장기에서 분비되는 소화효소. 췌장염, 신부전 시 상승."},
